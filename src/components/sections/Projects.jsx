          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="glass p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all">
              ...
              <div className="space-y-2 my-4">
                <a
                  href="https://ever-green-red-three.vercel.app/"
                  target="_blank"
                ...
                <a
                  href="https://ever-green-lilac.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-400 hover:text-blue-300 transition-colors block"
                >
              ...
              <div className="aspect-video mt-2">
                <iframe
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/Dev_fR1bhxY?si=BledcO6hrAcZGQQu"
            ...
            <div className="glass p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all">
              ...
              <p className="text-gray-400 mb-4">
                ...
                authentication, media uploads, and responsive design for modern
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                ...
                RESTful backend APIs. Deployed to multiple platforms for
